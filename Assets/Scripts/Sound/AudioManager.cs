...
public class AudioManager : MonoBehaviour
{
    ...
    [Header("Movement Sounds")] public AudioClip walk;
    ...
    [Header("Player Sounds")] public AudioClip playerHit;

    public AudioClip playerDeath;

    [Header("Alien Sounds")] public AudioClip alienGrowl;

    public AudioClip alienAlert;
    public AudioClip alienHit;
    public AudioClip alienDeath;

    [Header("Weapon sounds")] public AudioClip bulletHit;

    public AudioClip explosion;

    [Header("Music")] public AudioClip backgroundMusic;
    ...
    public AudioSource PlayLoopingAudio(AudioType type, float volume = -1f)
    {
        ...
        var loopingSource = gameObject.AddComponent<AudioSource>();
